...
namespace Kumbuthane.Models
{
    ...
    {
        private readonly KumbuthaneDbContext _kumbuthaneDbContext;
        internal DbSet<T> dbSet;

        public Repository(KumbuthaneDbContext kumbuthaneDbContext)
        {
            _kumbuthaneDbContext = kumbuthaneDbContext;
            this.dbSet = _kumbuthaneDbContext.Set<T>();
            _kumbuthaneDbContext.Kitaplar.Include(k => k.KitapTuru).Include(k => k.KitapTuruId);
        }
